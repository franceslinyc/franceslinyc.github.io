...
<p align="justify"> Beginning this summer, we will shift our focuses to focus on spatial prediction (e.g. kriging, copula) of big forestry inventory data. In the years to come, I aim to continue to work on and explore further spatial statistics, spatio-temporal modeling, machine learning, and big data while completing PhD coursework in statistics (e.g. decision theory, probability theory, linear model theory).</p>
