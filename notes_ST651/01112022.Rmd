...
Proof. Exercise or check p.42 of PDF (textbook). Use quadratic form from previous proof and rank. 
...
Check p.52 of PDF (textbook) for full definition. As a demonstration, suppose 
...
Check. p.38 of PDF for more. 


Note. We only need $B^{-1}$ and $A_{11}^{-1}$ and the rest are matrix multiplication. 

In addition, this is helpful when we need to compare $A_{11}^{-1} (- B^{-1} A_{21} A_{11}^{-1}) + A_{11}^{-1} A_{12} B^{-1} A_{21} A_{11}^{-1}$ to $A_{11}^{-1}$. Remove $(- B^{-1} A_{21} A_{11}^{-1})$ after comparing to p.38 of PDF. 
