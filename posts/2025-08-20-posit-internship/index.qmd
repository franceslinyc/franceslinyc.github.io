...
- Developing and releasing [filtro](https://filtro.tidymodels.org/dev/), a feature selection package for predictive modeling and ML within the [tidymodels](https://www.tidymodels.org) framework
...
- Connecting with others and learning across Posit [^jules]
...
But, why {tidymodels} instead of {scikit-learn}? I’ve found myself drawn to {scikit-learn} because of Python’s vast machine learning ecosystem, and since I already work with {pytorch}. At the same time, I really appreciate {tidymodels} when I’m working in R. Its syntax feels natural, the workflows are well-structured, and it reflects the kind of statistical rigor and thoughtful design that statisticians and data scientists had been shaping long before "machine learning" became a buzzword. If you want to learn more about {tidymodels}, check it out [here](https://www.tidymodels.org/packages/). 
...
Thanks for reading this, and I am happy to connect!