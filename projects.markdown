...
<p align="justify"> Description: These mini projects introduce and walk through selected machine learning algorithms such as random forest, boosting and k-means clustering and use Python Libraries such as scikit-learn to apply the algorithms to simulated (e.g. GMM) or real-world data (e.g. wine quality).
