...
<p align="justify"> Since Fall 2021, my co-advisors <a href="https://stat.oregonstate.edu/content/madsen-lisa" target="_blank"> Dr. Lisa Madsen</a> & <a href="https://stat.oregonstate.edu/content/wickham-charlotte" target="_blank"> Dr. Charlotte Wickham</a> (now at Posit PBC) and I have focused on predictive modeling, applied Bayesian, and machine learning for forestry inventory prediction and wind speed forecasting. We focus on Gaussian processes (GPs) and its variant models that are robust, flexible and scalable for larger datasets. </p> 
